...
public class ResponseSender implements ResponseAble<Response> {
    ...
    @Override
    public void sendResponse(CallerBack callerBack, Response response) throws IllegalArgumentException { // these comments are for me to not forget how this works
        if (response != null) {
            ...
            try {
                ...
                int maxPacketSize = UdpDataTransferUtilities.PACKET_SIZE.getPacketSizeValue(); // we must not have chunk which is longer than max packet size value
